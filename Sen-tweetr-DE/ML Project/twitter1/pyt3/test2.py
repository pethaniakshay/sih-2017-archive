...
print ("------------Positive------------")
print (loaded_model.classify(extract_features(getFeatureVector(test, stopWords))))
print ("------------Negative------------")
test2 = "Morning everyone! In serious need of some decent coffee.. why isn't the catering open yet at 08.30?"
print (loaded_model.classify(extract_features(getFeatureVector(test2, stopWords))))